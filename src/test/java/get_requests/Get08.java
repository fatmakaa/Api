...
*/
    ...
    public void get(){
      ...
      //Do Assertion
        ...
        // Assert that there are 10 ids greater than 190
        List <Integer> idListFromGroovy =  json.getList("findAll{it.id>190}");
        System.out.println("idListFromGroovy = " + idListFromGroovy);
        ...
        List <Integer> lessThanFive = json.getList("findAll{it.id<5}.userId");
        System.out.println("lessThanFive = " + lessThanFive);


       // Assert that the number of userIds whose ids are less than 5 is 4
        assertEquals(4,lessThanFive.size());


        //Print all titles whose ids are less than 5
        List<String> allTitlesLessThanFive =  json.getList("findAll{it.id<5}.title");
        System.out.println("allTitlesLessThanFive = " + allTitlesLessThanFive);


        //Assert that "delectus aut autem" is one of the titles whose id is less than 5

        assertTrue(allTitlesLessThanFive.contains("delectus aut autem"));
